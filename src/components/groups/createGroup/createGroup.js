...
class CreateGroup extends Component {
    ...
    handleSubmit = () => {
        ...
        axios.post(GROUP_POST_URL, data, {crossDomain: true, withCredentials: true}).then(response => {
            // eslint-disable-next-line no-console
    ...
    render() {
        return (
            <div className='create_group_container'>
                <div className='create_group_component'>
                    <form className="new_group col align-center">
                        <h2>Create Group</h2>
                        <p className='title_create_group'>Group title:</p>
                        <input type="text"
                               name="title"
                               className="group_input"
                               onChange={this.handleTitleChange}/>
                        <div>
                            <label className='title_create_group'>Add members:</label>
                            <Select
                        ...
                        <div>
                            <p className='title_create_group'>Assign to forms:</p>
                    ...
                    <div className="submit">
                        <input className='btn submit_btn' type='button' value="Submit"
